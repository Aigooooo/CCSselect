    ...
    if(!empty($firstName) || !empty($lastName) || !empty($age) || !empty($email) || !empty($password) ||!empty($phoneNumber))
    {
        ...
        if($rowNum==0)
        {
            ...
            if($stmt)
            {
                ...
                $mail->Body="<p>Dear $firstName, </p> <h3>Your verification code is $otp. <br>Thank you for signing up ٩(＾◡＾)۶</h3>
                <br><br>
                <p>Your's truly,</p>
                <b>CCSselect</b>";
                        ...
                        if(!$mail->send()){
                            ...
                            <script>
                                ...
                                window.location.replace('/CCSselect/SKILL_SETUP/setupPortfolio.php');
                            </script>
                            <?php
                        }
            }
